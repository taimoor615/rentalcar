                                ...
                                <div class="card">
                                    @if($booking->car->getFirstMediaUrl('images'))
                                        ...
                                        <!--     alt="{{ $booking->car->title }}">-->
                                             <img src="{{ asset(parse_url($booking->car->getFirstMediaUrl('images', 'thumb'), PHP_URL_PATH)) }}"
     class="card-img-top listing-image" style="height: 200px; object-fit: cover;"alt="{{ $booking->car->title }}">
                                    @endif

                                    <div class="card-body">
                                        <h6 class="card-title">{{ $booking->car->title }}</h6>
                                        <p class="text-muted small">{{ $booking->car->location }}</p>
