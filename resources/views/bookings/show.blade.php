<x-app-layout>
    ...
    <div class="container my-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                @if($booking->car->getFirstMediaUrl('images'))
                                    <img src="{{ asset(parse_url($booking->car->getFirstMediaUrl('images', 'large'), PHP_URL_PATH)) }}"
     ...
     alt="{{ $booking->car->title }}">
                                ...
                                <p class="text-muted">{{ $booking->car->location }}</p>

                                <div class="mb-3">
                                    <strong>Owner:</strong> {{ $booking->car->owner->name }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-2">
                                    <strong>Take Car:</strong> {{ $booking->start_date->format('l, F j, Y') }}
                                </div>

                                <div class="mb-2">
                                    <strong>Return Car:</strong> {{ $booking->end_date->format('l, F j, Y') }}
                                </div>

                                <div class="mb-2">
                                    <strong>Duration:</strong> {{ $booking->days }} Day{{ $booking->days > 1 ? 's' : '' }}
                                </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('listings.show', $booking->car) }}" class="btn btn-outline-primary w-100 mb-2">
                            View Listing
                        </a>
